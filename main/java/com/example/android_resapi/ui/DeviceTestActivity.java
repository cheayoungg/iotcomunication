    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startGetBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timer.schedule(new TimerTask() {
                                   @Override
                                   public void run() {
                                       new GetThingShadow(DeviceTestActivity.this, urlStr).execute();
                                   }
                               },
                        0,2000);
        ...
        fanspeedBtn0.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (payload.length() >0 ) {
                    Toast.makeText(DeviceTestActivity.this,"세기: 0", Toast.LENGTH_SHORT).show();
                    new UpdateShadow(DeviceTestActivity.this, urlStr).execute(payload);
                }
                else
                    Toast.makeText(DeviceTestActivity.this,"변경할 상태 정보를 선택하세요", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        fanspeedBtn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i(TAG,"payload="+payload);
                if (payload.length() >0 ) {
                    Toast.makeText(DeviceTestActivity.this,"세기: 1", Toast.LENGTH_SHORT).show();
                    new UpdateShadow(DeviceTestActivity.this, urlStr).execute(payload);
                }
                else
                    Toast.makeText(DeviceTestActivity.this,"변경할 상태 정보를 선택하세요", Toast.LENGTH_SHORT).show();
        ...
        fanspeedBtn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i(TAG,"payload="+payload);
                if (payload.length() >0 ) {
                    Toast.makeText(DeviceTestActivity.this,"세기: 2", Toast.LENGTH_SHORT).show();
                    new UpdateShadow(DeviceTestActivity.this, urlStr).execute(payload);
                }
                else
                    Toast.makeText(DeviceTestActivity.this,"변경할 상태 정보를 선택하세요", Toast.LENGTH_SHORT).show();
        ...
        fanspeedBtn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i(TAG,"payload="+payload);
                if (payload.length() >0 ) {
                    Toast.makeText(DeviceTestActivity.this,"세기: 3", Toast.LENGTH_SHORT).show();
                    new UpdateShadow(DeviceTestActivity.this, urlStr).execute(payload);
                }
                else
                    Toast.makeText(DeviceTestActivity.this,"변경할 상태 정보를 선택하세요", Toast.LENGTH_SHORT).show();
        ...
        fanBtnB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i(TAG,"payload="+payload);
                if (payload.length() >0 ) {
                    Toast.makeText(DeviceTestActivity.this,"fan방향: BACK", Toast.LENGTH_SHORT).show();
                    new UpdateShadow(DeviceTestActivity.this, urlStr).execute(payload);
                }
                else
                    Toast.makeText(DeviceTestActivity.this,"변경할 상태 정보를 선택하세요", Toast.LENGTH_SHORT).show();
        ...
        fanBtnS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i(TAG,"payload="+payload);
                if (payload.length() >0 ) {
                    Toast.makeText(DeviceTestActivity.this,"fan방향: STOP", Toast.LENGTH_SHORT).show();
                    new UpdateShadow(DeviceTestActivity.this, urlStr).execute(payload);
                }
                else
                    Toast.makeText(DeviceTestActivity.this,"변경할 상태 정보를 선택하세요", Toast.LENGTH_SHORT).show();
        ...
        fanBtnF.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i(TAG,"payload="+payload);
                if (payload.length() >0 ) {
                    Toast.makeText(DeviceTestActivity.this,"fan방향: FRONT", Toast.LENGTH_SHORT).show();
                    new UpdateShadow(DeviceTestActivity.this, urlStr).execute(payload);
                }
                else
                    Toast.makeText(DeviceTestActivity.this,"변경할 상태 정보를 선택하세요", Toast.LENGTH_SHORT).show();
